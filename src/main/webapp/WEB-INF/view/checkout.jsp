...
<body>
                                ...
                                <ul class="ht-menu">
                                    ...
                                    <li>
                                        ...
                                        <div class="language ht-language">
                                            <ul class="ht-setting-list">
                                                <li class="active"><a href="#"><img src="/JT-Project-S/static/images/menu/flag-icon/1.jpg"
                                                            alt="">English</a></li>
    ...
    <!-- /JT-Project-S/static/imagesloaded js -->
    <script src="js//JT-Project-S/static/imagesloaded.pkgd.min.js"></script>
    <!-- Mixitup js -->
