...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/static/css/material-design-iconic-font.min.css">
<!-- Font Awesome -->
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/static/css/font-awesome.min.css">
<!-- Font Awesome Stars-->
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/static/css/fontawesome-stars.css">
<!-- Meanmenu CSS -->
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/static/css/meanmenu.css">
<!-- owl carousel CSS -->
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/static/css/owl.carousel.min.css">
<!-- Slick Carousel CSS -->
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/static/css/slick.css">
<!-- Animate CSS -->
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/static/css/animate.css">
<!-- Jquery-ui CSS -->
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/static/css/jquery-ui.min.css">
<!-- Venobox CSS -->
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/static/css/venobox.css">
<!-- Nice Select CSS -->
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/static/css/nice-select.css">
<!-- Magnific Popup CSS -->
<link rel="stylesheet"
	href="/JT-Project-S/static/css/magnific-popup.css">
										...
										<div class="language ht-language">
											<ul class="ht-setting-list">
												<li class="active"><a href="#"><img
														src="/JT-Project-S/static/images/menu/flag-icon/1.jpg"
														alt="">English</a></li>
												<li><a href="#"><img
														src="/JT-Project-S/static/images/menu/flag-icon/2.jpg"
														alt="">Fran̤ais</a></li>
											</ul>
										</div></li>
						...
						<div class="col-lg-3">
							<div class="logo pb-sm-30 pb-xs-30">
								<a href="index.html"> <img
									src="/JT-Project-S/static/images/menu/logo/1.jpg" alt="">
								</a>
							</div>
						</div>
							...
							<div class="hb-menu">
								<nav>
									<ul>
										...
										<li class="megamenu-/JT-Project-S/static-holder"><a
					...
					<div class="footer-shipping pt-60 pb-55 pb-xs-25">
						<div class="row">
							...
							<div class="col-lg-3 col-md-6 col-sm-6 pb-sm-55 pb-xs-55">
								<div class="li-shipping-inner-box">
									<div class="shipping-icon">
										<img src="/JT-Project-S/static/images/shipping-icon/1.png"
											alt="Shipping Icon">
									</div>
							...
							<div class="col-lg-3 col-md-6 col-sm-6 pb-sm-55 pb-xs-55">
								<div class="li-shipping-inner-box">
									<div class="shipping-icon">
										<img src="/JT-Project-S/static/images/shipping-icon/2.png"
											alt="Shipping Icon">
									</div>
									<div class="shipping-text">
										<h2>Safe Payment</h2>
							...
							<div class="col-lg-3 col-md-6 col-sm-6 pb-xs-30">
								<div class="li-shipping-inner-box">
									<div class="shipping-icon">
										<img src="/JT-Project-S/static/images/shipping-icon/3.png"
											alt="Shipping Icon">
									</div>
									<div class="shipping-text">
							...
							<div class="col-lg-3 col-md-6 col-sm-6 pb-xs-30">
								<div class="li-shipping-inner-box">
									<div class="shipping-icon">
										<img src="/JT-Project-S/static/images/shipping-icon/4.png"
											alt="Shipping Icon">
									</div>
									<div class="shipping-text">
						...
						<div class="row">
							...
							<div class="col-lg-4 col-md-6">
								<div class="footer-logo">
									<img src="/JT-Project-S/static/images/menu/logo/1.jpg"
										alt="Footer Logo">
					...
					<div class="row">
						<div class="col-lg-12">
							...
							<div class="copyright text-center">
								<a href="#"> <img
									src="/JT-Project-S/static/images/payment/1.png" alt="">
								</a>
							</div>
